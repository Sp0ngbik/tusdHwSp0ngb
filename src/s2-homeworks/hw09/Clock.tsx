...
function Clock() {
    ...
    const start = () => {
        ...
        setTimerId(Number(intervalDate))
    ...
    const daysOnEN = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']
    const stringDay = daysOnEN[(date.getDay()) - 1] || <br/> // пишут студенты
